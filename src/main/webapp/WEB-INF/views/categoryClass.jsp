...
<html>
	...
	<body>
        ...
        <div class="swiper-slide">
          <div class="card" style="border-radius: 16px; overflow: hidden;">
            <img src="<c:url value='/resources/img/class3.jpg'/>" class="card-img-top" alt="...">
            <div class="card-body p-2">
              <h6 class="mb-1 fw-bold">클래스 디자인 입문</h6>
              <p class="mb-0 text-muted" style="font-size: 14px;">UI/UX의 모든 것</p>
            </div>
          </div>
        </div>
