...
CREATE TABLE `SUBSCRIBE` (
	...
	`SU_DATE`	DATE  DEFAULT CURRENT_TIMESTAMP NOT	NULL,
...
CREATE TABLE `COMMENT` (
	...
	`CO_DATE`	DATE DEFAULT CURRENT_TIMESTAMP NOT	NULL,
...
CREATE TABLE `CLASS` (
	...
	`CL_DATE`	DATE DEFAULT CURRENT_TIMESTAMP NOT	NULL,
...
CREATE TABLE `REQUEST` (
	...
	`RQ_DATE`	DATE DEFAULT CURRENT_TIMESTAMP NOT	NULL,
