...
CREATE TABLE `SUBSCRIBE` (
    ...
    `SU_STATUS`	ENUM("normal", "regular") DEFAULT "regular"	NULL
);
...
CREATE TABLE `REQUEST` (
	...
	`RQ_STATE`	ENUM("WAITING", "HANDLING", "OK", "NO") DEFAULT "WAITING"	NULL,
	`RQ_DATE`	DATETIME DEFAULT CURRENT_TIMESTAMP NOT	NULL,
	`RQ_CONTENT`	LONGTEXT NOT	NULL,
